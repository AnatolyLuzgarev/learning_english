...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'my_site/templates/trainings'),
            os.path.join(BASE_DIR, 'my_site/templates/calculators')
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'my_site/static_files'),
    os.path.join(BASE_DIR, 'my_site/bootstrap')
)